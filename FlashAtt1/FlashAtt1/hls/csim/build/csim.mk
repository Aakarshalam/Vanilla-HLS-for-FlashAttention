...
HLS_SOURCES = ../../../../flashattentiontb.cpp ../../../../flashattentionkernal.cpp
...
$(ObjDir)/flashattentiontb.o: ../../../../flashattentiontb.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../flashattentiontb.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/flashattentiontb.d

$(ObjDir)/flashattentionkernal.o: ../../../../flashattentionkernal.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../flashattentionkernal.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/flashattentionkernal.d
