...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "flash_attention_kernel.autotvin.dat"
	set constFileTvOut       "flash_attention_kernel.autotvout.dat"
	set constFileHdlTvIn     "flash_attention_kernel.autohdltvin.dat"
	set constFileHdlTvOut    "flash_attention_kernel.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
